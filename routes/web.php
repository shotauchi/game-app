...
// Route::get('/search/consoles', [HomeController::class, 'searchConsoles'])->name('consoles.search');
// Route::get('/search/performances', [HomeController::class, 'searchPerformances'])->name('performances.search');
